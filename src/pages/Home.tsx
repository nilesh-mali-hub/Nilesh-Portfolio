  ...
  return (
    <div className="min-h-screen bg-neutral-950 text-white pb-20 overflow-x-hidden font-sans relative">
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 md:px-8 w-full relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mt-4">
          ...
          <div className="col-span-1 flex flex-col gap-4 order-2 md:order-1">
            ...
            <div className="flex flex-wrap gap-2 justify-start">
              <Badge colorClass="" icon={<Fingerprint className="w-5 h-5"/>} delay={0.2}>Brand<br/>Identity</Badge>
              <Badge colorClass="" icon={<Search className="w-5 h-5"/>} delay={0.3}>Attention<br/>to Detail</Badge>
              <Badge colorClass="" icon={<Eye className="w-5 h-5"/>} delay={0.4}>Visual<br/>Design</Badge>
              <Badge colorClass="" icon={<Lightbulb className="w-5 h-5"/>} delay={0.5}>Creative<br/>Strategy</Badge>
              <Badge colorClass="" icon={<LayoutGrid className="w-5 h-5"/>} delay={0.6}>UI / UX</Badge>
            </div>
          </div>
        ...
        {/* Services Section */}
        <div className="mt-28">
          <SectionHeading delay={0.1}>Capabilities</SectionHeading>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-8">
            <ServiceCard 
              title="Brand Identity"
              description="Crafting distinctive and memorable visual identities that capture the essence of your business and resonate with your audience."
              icon={<PenTool className="w-6 h-6" />}
              delay={0.2}
            />
            <ServiceCard 
              title="UI/UX Design"
              description="Designing intuitive, user-centric interfaces for web and mobile that deliver seamless and engaging digital experiences."
              icon={<Layers className="w-6 h-6" />}
              delay={0.3}
            />
            <ServiceCard 
              title="Motion & Media"
              description="Bringing ideas to life through dynamic motion graphics, engaging video edits, and compelling social media visuals."
        ...
        <div className="mt-32">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 md:grid-rows-[auto_auto_auto_auto] gap-4 mt-8">
            ...
            {/* LinkedIn */}
            <BentoCard className="md:col-start-4 md:row-start-1 md:row-span-2 p-8 flex flex-col justify-center min-h-[200px] group hover:border-[#D1FF52] transition-colors relative" delay={0.4}>
            ...
            {/* Instagram */}
            <BentoCard className="md:col-start-2 md:col-span-2 md:row-start-2 md:row-span-2 p-6 flex flex-col sm:flex-row gap-6 min-h-[200px] relative group" delay={0.5}>
